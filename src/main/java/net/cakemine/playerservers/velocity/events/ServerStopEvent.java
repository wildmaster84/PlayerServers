...
public class ServerStopEvent implements ResultedEvent<GenericResult>{
    PlayerServers pl;
    ...
    public ServerStopEvent(PlayerServers pl, ServerInfo serverInfo, UUID uuid, int memx, int mems) {
        this.pl = pl;
